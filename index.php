...
<html>
  <head>
    ...
    <meta name="google-site-verification" content="kIxAeQh52SXI2DHNlM2uQZkORDehMnxId_PaeJcNI6g" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="https://fonts.googleapis.com/css?family=Catamaran:100,200,300,400,500,600,700,800,900%70cCormorant+Garamond:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="style.css">
    <link rel="shortcut icon" type="img/jpg" href="img/ppty.jpg">
  </head>
  <body>
    <header>
    ...
    <div class="wrapper">
      <footer>
        ...
        <ul class="footer-links-cases">
          ...
          <li><a href="#">MAILING SHAOIN - WEB DEVELOPMENT</a></li>
        ...
        <div class="footer-sm">
          <a href="#">
            <img src="img/youtube.png" alt="youtube icon"></a>
          <a href="#">
